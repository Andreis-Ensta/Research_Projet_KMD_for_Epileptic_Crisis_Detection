# -*- coding: utf-8 -*-
"""
Created on Wed Aug 17 14:57:51 2022
...
def variance_parameters_calculation(signal_to_treat,jump,kernel_lenght,data,Kmode,Ktot,Z,signal_size):
    ...
    plt.axis([0,len(Er_values_var), 0, 7*var_mean])
